...
#if canImport(domain_commonFFI)
import domain_commonFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_domain_common_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_domain_common_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureDomainCommonInitialized()
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeErrorDisplay: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ErrorDisplay {
        return
            try ErrorDisplay(
                title: FfiConverterString.read(from: &buf), 
                subtitle: FfiConverterString.read(from: &buf)
    ...
    public static func write(_ value: ErrorDisplay, into buf: inout [UInt8]) {
        FfiConverterString.write(value.title, into: &buf)
        FfiConverterString.write(value.subtitle, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeErrorDisplay_lift(_ buf: RustBuffer) throws -> ErrorDisplay {
    return try FfiConverterTypeErrorDisplay.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeErrorDisplay_lower(_ value: ErrorDisplay) -> RustBuffer {
    return FfiConverterTypeErrorDisplay.lower(value)
}
...
public struct FfiConverterTypeDomainError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DomainError {
        ...
        case 1: return .Error(
            display: try FfiConverterTypeErrorDisplay.read(from: &buf)
            )
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDomainError_lift(_ buf: RustBuffer) throws -> DomainError {
    return try FfiConverterTypeDomainError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDomainError_lower(_ value: DomainError) -> RustBuffer {
...
public func uniffiEnsureDomainCommonInitialized() {
